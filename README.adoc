...
:experimental:
:url-github: https://github.com/hyperpolymath/Blue-Screen-of-App
:url-gitlab: https://gitlab.com/hyperpolymath/Blue-Screen-of-App
:url-bitbucket: https://bitbucket.org/hyperpolymath/Blue-Screen-of-App
:url-codeberg: https://codeberg.org/hyperpolymath/Blue-Screen-of-App

Application crash analysis and diagnostic toolkit
...
Blue-Screen-of-App is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
