...
[source,bash]
----
# ReScript compilation is optional
# Stub .bs.js files are already included for testing

# If you want to compile ReScript properly:
# 1. Install Deno (already have it)
# 2. Use the stub files (recommended for now)
# 3. OR install ReScript compiler separately if needed
