...
├── Podmanfile                     # Container configuration
...
3. Run `deno task dev`
4. Run `just build --if-present`
5. Run `deno task test` (if tests exist)
6. Upload artifacts
...
3. **Podman Multi-stage** - Smaller production images
...
5. **Non-root user** - Podman security
...
* **Scalability** - Podman, health checks, metrics
