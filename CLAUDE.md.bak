...
│   ├── utils/
│   │   ├── analytics.js           # In-memory analytics
│   │   ├── errorMessages.js       # Error codes and messages
│   │   └── logger.js              # Winston logger configuration
│   ├── views/
│   │   ├── bsod-win10.ejs        # Windows 10 style template
│   │   ├── bsod-win11.ejs        # Windows 11 style template
│   │   ├── bsod-win7.ejs         # Windows 7/8 style template
│   │   └── bsod-winxp.ejs        # Windows XP style template
...
│   │   └── errorMessages.test.js # Error message tests
│   └── integration/
│       ├── api.test.js           # API endpoint tests
│       └── bsod.test.js          # BSOD route tests
